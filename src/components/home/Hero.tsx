  ...
  return (
    <div className='py-[150px] bg-[url("/hero.png")] bg-cover bg-no-repeat bg-right flex items-center'>
      <div className='container mx-auto px-4'>
        ...
        <div className={`bg-gradient-to-r pl-12 from-[#c10505] to-[#045EE1] w-[300px] rounded-sm py-2 px-[15px] text-[16px] ${fontPoppins.className} mb-[20px]`} data-aos="flip-up">
          Welcome to WEBDEVIndo
        </div>

        {/* Heading with adjusted size and spacing */}
        <h1 className={`text-[60px] leading-[65px] ${fontPassionOne.className} text-white mb-7`} data-aos="flip-up">
          Professional WordPress <br /> And Frontend Developer
        </h1>

        {/* Hire me button */}
        <Link href="/contact">
          <button className={`mt-6 bg-blue-600 text-white py-3 px-8 rounded-lg text-lg ${fontInter.className} hover:bg-gradient-to-br from-[#045EE1] to-[#C10505]`} data-aos="flip-up">
            Hire me
          </button>
        </Link>
      </div>
